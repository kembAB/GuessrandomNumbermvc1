...
namespace MVCBasicsGussingGameAssignment3Try3.Model
{
    public class GuessRandomNumber
    {
        public static string Guess(int secretNumber, int guess, int tries, int highScore, out bool wonGame, out bool newHighScore)
        {
            ...
            {
                message += " <br /> Random Generated number is higher than your guess!";
            }
            else if (guess > secretNumber)
            {
                message += " <br />Random Generated number is lower than your guess!";
            }
